 <header class="bg-background py-5">
     <div class="mx-auto px-4 sm:px-14 h-24 flex items-center text-black">
         ...
         <div class="md:col-span-8 py-6 bg-white">
             ...
             <div class="border-b border-black/10 py-8 px-10 cart-item" data-price="10000">
                 <div class="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 items-start md:items-center">
                     ...
                     <div class="md:col-span-2">
                         ...
                         <img src="assets/images/products/one.png" alt="Product" class="w-24 h-32 object-cover" />
                     </div>
                     <div class="md:col-span-10 text-[0.75rem] space-y-7">
                         <div class="flex items-center justify-between">
                             <div></div>
                             <div class="text-[1rem]" style="font-weight: 500">Product Name</div>
                         </div>
                         ...
                         <div class="flex flex-col">
                             ...
                             <div class="flex items-center justify-between">
                                 <p class="mb-2">Colour : [Black; in material name]</p>
                                 <div></div>
                             </div>
                             <div class="flex items-center justify-between">
                                 <p>Size : Large</p>
                     ...
                     <div class="col-span-2">
                         <div class="flex items-center justify-start md:justify-center gap-4 mt-6 text-[0.75rem]">
                             ...
                             <div class="flex items-center gap-3">
                                 <button class="px-1 qty-minus" style="font-weight: 100">
                                     <i class="fa-solid fa-minus"></i>
                                 </button>

                                 <span class="qty">1</span>
                                 <button class="px-1 qty-plus" style="font-weight: 100">
             ...
             <div class=" py-8 px-10 bag-total-box">
                 ...
                 <div class="flex items-center justify-between text-[0.875rem]" style="font-weight: 500">
                     ...
                     <div class="bag-total">₹ 20,000</div>
