...
<div class="bg-white border-x-[1rem] border-secondary text-black">
    ...
    <div class="max-w-lg mx-auto px-6 pt-5">
        ...
        <div class="relative mt-16 location-wrapper-shipping">
            <input type="text" id="location-shipping" name="location" autocomplete="off" required
                oninput="handleFilledLocationShippingProfile(this)" onclick="toggleDropdownLocationShipping()"
            ...
            <div id="locationDropdownShippingProfile"
                ...
                <p class="size-option cursor-pointer px-6 py-2 hover:bg-black hover:text-white"
                    onclick="selectLocationShippingProfile('India')">India</p>
                <p class="size-option cursor-pointer  px-6 py-2 hover:bg-black hover:text-white"
                    onclick="selectLocationShippingProfile('Italy')">Italy</p>
                <p class="size-option cursor-pointer  px-6 py-2 hover:bg-black hover:text-white"
                    onclick="selectLocationShippingProfile('France')">France</p>
                <p class="size-option cursor-pointer  px-6 py-2 hover:bg-black hover:text-white"
                    onclick="selectLocationShippingProfile('Japan')">Japan</p>
                <p class="size-option cursor-pointer  px-6 py-2 hover:bg-black hover:text-white"
                    onclick="selectLocationShippingProfile('Thailand')">Thailand</p>
                <p class="size-option cursor-pointer  px-6 py-2 hover:bg-black hover:text-white"
                    onclick="selectLocationShippingProfile('Indonesia')">Indonesia</p>
                <p class="size-option cursor-pointer  px-6 py-2 hover:bg-black hover:text-white"
                    onclick="selectLocationShippingProfile('Saudi Arabia')">Saudi Arabia</p>
                <p class="size-option cursor-pointer  px-6 py-2 hover:bg-black hover:text-white"
                    onclick="selectLocationShippingProfile('China')">China</p>
            </div>
...
<script>
    (function() {
        const input = document.getElementById("location-shipping");
        const dropdown = document.getElementById("locationDropdownShippingProfile");
        const chevron = document.getElementById("sizeChevronlocationshipping");
        const wrapper = document.querySelector(".locaiton-wrapper-shipping");

        window.toggleDropdownLocationShipping = function() {
            dropdown.classList.toggle("hidden");
            chevron.classList.toggle("rotate-180");
        };

        window.selectLocationShippingProfile = function(value) {
            input.value = value;
        ...
        window.handleFilledLocationShippingProfile = function(el) {
            if (el.value.trim() !== "") {
