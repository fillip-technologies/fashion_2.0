                        ...
                        <div class="form-column">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" rows="5"
                                    class="form-control @error('description') is-invalid @enderror" placeholder="Detailed product description...">{{ old('description') }}</textarea>
                                @error('description')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="the_line" id="description" rows="5" class="form-control @error('the_line') is-invalid @enderror"
                                    placeholder="Detailed the line description...">{{ old('description') }}</textarea>
                                @error('the_line')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="product_story" id="description" rows="5"
                                    ...
                                    placeholder="Detailed product story description...">{{ old('description') }}</textarea>
                                @error('product_story')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-column">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="material_breakdown" id="description" rows="5"
                                    ...
                                    placeholder="Detailed Material Breakdown description...">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="packaging" id="description" rows="5"
                                    class="form-control @error('packaging') is-invalid @enderror" placeholder="Detailed Packaging description...">{{ old('description') }}</textarea>
                                @error('packaging')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="payment" id="description" rows="5"
                                    class="form-control @error('payment') is-invalid @enderror" placeholder="Detailed Payment description...">{{ old('description') }}</textarea>
                                @error('payment')
                                    <span class="error-message">{{ $message }}</span>
                                @enderror
                            </div>
