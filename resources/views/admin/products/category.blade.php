        ...
        <div class="category-card">
            <div class="card-header">
                <h2>
                    ...
                    {{ !empty($dataedit) ? 'Edit Category Form' : 'Add Category Form' }}
                </h2>
            ...
            <div class="card-body">
                ...
                @if (!empty($dataedit))
                    <form action="{{ route('admin.update.category',$dataedit->id) }}" method="POST" id="categoryForm">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="{{ old('name', $dataedit->name ?? '') }}" autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" id="slug"
                                class="form-control @error('slug', $dataedit->slug ?? '') is-invalid @enderror"
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('admin.product.category') }}" class="btn-secondary" onclick="resetForm()">
                                <i class="fas fa-undo-alt"></i> Back
                            </a>
                        </div>
                    </form>
                @else
                    <form action="{{ route('admin.add.categories') }}" method="POST" id="categoryForm">
                        @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <a href="{{ route('admin.edit.categories', $category->id) }}" class="btn-edit">
                                            <i class="fas fa-edit"></i>
                                            Edit
                                        </a>

                                        <form action="{{ route('admin.delete.categories', $category->id) }}"
                                            method="POST"
