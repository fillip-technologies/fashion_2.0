        ...
        <div class="stat-card bg-white rounded-xl shadow p-6 border-l-4 border-primary transition duration-300">
            <div class="flex justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-dark mt-2">{{ App\Models\User::count() }}</h3>
                </div>
        ...
        <div class="stat-card bg-white rounded-xl shadow p-6 border-l-4 border-purple-500 transition duration-300">
            <div class="flex justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-dark mt-2">{{ App\Models\Product::count() }}</h3>
                </div>
                    ...
                    <tbody>
                        @foreach (App\Models\User::all() as $users)
                            <tr class="border-b text-sm">
                                ...
                                <td class="py-3">{{ $users->email }}</td>
                                <td class="py-3">{{ $users->address }}</td>
                                <td class="py-3">
                                    {{ $users->phone }}
                                </td>
                            </tr>
