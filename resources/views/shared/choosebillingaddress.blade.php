            ...
            md:items-center md:justify-between gap-4 md:gap-0">
              ...
              leading-snug md:leading-normal"
                ...
                <div class="flex items-center justify-end space-x-4">
                    ...
                    <button
                        onclick="toggleMasterDrawer('choosebillingaddress'); toggleMasterDrawer('changebillingaddress');"
                ...
                <div class="relative">
                    <div class="text-[0.75rem]" style="font-weight: 400">
                        <div class="w-10/12 mx-auto py-16">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-2 md:gap-x-32 gap-y-20 text-[0.75rem]"
                                style="font-weight: 300">

                                <!-- Address 1 -->
                                <div class="flex items-start justify-center gap-4">
                                    <input type="radio" class="mt-1 w-3 h-3 accent-primary" />
