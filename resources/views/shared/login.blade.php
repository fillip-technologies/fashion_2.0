...
<nav id="drawerlogin"
    ...
    <div class="flex h-screen">
        ...
        <div
            class="drawerlogin-panel relative h-screen w-full md:w-2/3 shrink-0 overflow-hidden overscroll-none bg-black/80">
                        ...
                        <div id="login">
                            ...
                            <div class="px-6 md:px-24 max-w-3xl mx-auto">
                                ...
                                <a href="{{ url('/createaccount') }}"
                                    class="block w-full mt-2 text-center py-2 rounded
    border border-white/70
    text-[0.75rem] tracking-widest
    text-white
    transition-all duration-300 ease-out
    ...
    hover:border-transparent">
                 ...
                 hover:border-none">
                    ...
                    {{-- Confirm Password --}}
                    <div id="confirmpassword" class="hidden min-h-[calc(100vh-120px)] flex items-center justify-center">
                        <div class="px-6 md:px-24 md:max-w-3xl mx-auto w-full">
                            ...
                            <p class="text-[0.75rem] leading-relaxed text-white/70" style="font-weight: 200">
                                ...
                                <br />
                                | At least 8 characters | At least 1 upper case | At least 1 lower case | At least 1
                                digit |
                                At
