<nav id="drawersizeguide"
    ...
    <div id="detailedSection" class="hidden">
        ...
        <div class="mt-0 py-4 px-6 md:px-14 max-w-3xl mx-auto flex items-center justify-center gap-20 text-[0.875rem]">
        ...
        <div class="mt-10 pb-20  flex-1">
            ...
            <div class="max-w-md mx-auto pt-16 pb-4 flex items-center justify-center font-medium">How to measure
                yourself:</div>
            ...
            <div class="px-6 md:px-14 pt-20 pb-10">
                <div class="max-w-lg mx-auto space-y-10">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-9 text-[0.75rem] leading-relaxed text-black" style="font-weight: 300">
