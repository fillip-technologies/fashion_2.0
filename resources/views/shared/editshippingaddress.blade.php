            ...
            md:items-center md:justify-between gap-4 md:gap-0">
              ...
              leading-snug md:leading-normal"
                ...
                <div class="flex items-center justify-end space-x-4">
                    <button onclick="toggleMasterDrawer('editshippingaddress')"
                ...
                <div class="relative">
                    <div class="text-[0.75rem]" style="font-weight: 400">
                        <div class="px-6 md:px-8 grid grid-cols-12 md:gap-x-10 gap-y-7 text-[0.6875rem] relative py-8">
                            ...
                            <div class="col-span-12 space-y-5 relative phone-wrapper-shipping-edit">
                                ...
                                <div class="grid grid-cols-12 gap-4 items-end">
                                    ...
                                    <div class="col-span-4 flex items-center justify-between gap-3
                                        ...
                                        onclick="togglecountryDropdownshippingedit()">

                                        <div class="flex items-center gap-3">
                                            <span id="selectedCountrybilling" class="text-[0.75rem]" style="font-weight: 400">
                                                In
                                            </span>

                                            <span id="selectedCodebilling" class="text-[0.75rem] text-black/60"
                                                style="font-weight: 400">
                                                (+91)
                                            </span>
                                        </div>

                                        <i id="phoneChevronbilling"
                                ...
                                bg-background shadow-2xl z-[300] hidden">
                                    ...
                                    <div class="px-6 py-5 space-y-4 text-[0.75rem]" style="font-weight: 400">
                                        ...
                                        <div onclick="selectCountryshippingedit('In', '+91')"
                                            class="flex justify-between cursor-pointer hover:opacity-70">
                                            <span>India</span>
                                            <span>(+91)</span>
                                        </div>

                                        <div onclick="selectCountryshippingedit('It', '+39')"
                                            class="flex justify-between cursor-pointer hover:opacity-70">
                                            <span>Italy</span>
                                            <span>(+39)</span>
                                        </div>

                                        <div onclick="selectCountryshippingedit('Fr', '+33')"
                                            class="flex justify-between cursor-pointer hover:opacity-70">
                                            <span>France</span>
                                            <span>(+33)</span>
                                        </div>

                                        <div onclick="selectCountryshippingedit('Jp', '+81')"
                                            class="flex justify-between cursor-pointer hover:opacity-70">
                                            <span>Japan</span>
                                            <span>(+81)</span>
                                        </div>
                        ...
                        <div class="flex justify-center my-5">
                            <button class="px-16 py-3 bg-secondary hover:bg-primary rounded text-white text-[1rem]"
                                ...
                                onclick="toggleMasterDrawer('editshippingaddress')"
                                >
                                Save
                            </button>
                        </div>
...
<script>
    function togglecountryDropdownshippingedit() {
        const dropdown = document.getElementById("countryDropdownbilling");
        const chevron = document.getElementById("phoneChevronbilling");

        dropdown.classList.toggle("hidden");
        chevron.classList.toggle("rotate-180");
    }

    function selectCountryshippingedit(code, dial) {
        document.getElementById("selectedCountrybilling").textContent = code;
        document.getElementById("selectedCodebilling").textContent = `(${dial})`;

        document.getElementById("countryDropdownbilling").classList.add("hidden");
        document.getElementById("phoneChevronbilling").classList.remove("rotate-180");
    }

    // Optional: click outside to close
    document.addEventListener("click", function(e) {
        const wrapper = document.querySelector(".phone-wrapper-shipping-edit");
