        ...
        <div class="relative min-h-full">
            ...
            <div class="py-6 px-6 md:px-8 flex items-center justify-between">
                <p class="text-[0.875rem] underline underline-offset-1 decoration-secondary" style="font-weight: 400">
                    Add a new Billing <span class="text-[1.25rem]" style="font-weight: 500">Address</span>
                </p>
                <div class="flex space-x-2">
                    <button class="text-[0.875rem] underline text-black/50">
                        Choose Address
                    </button>
                    <button onclick="toggleMasterDrawer('changebillingaddress')" class="text-3xl font-light text-black/60 hover:text-black z-50">
                        &times;
                    </button>
                </div>
            </div>
            ...
            <div class="px-8">
                <div class="relative">
                    <div class="text-[0.75rem]" style="font-weight: 400">
                        ...
                        <div
                            class=" px-6 md:px-8 flex items-center justify-center gap-3 mt-5 text-[0.625rem] text-black/60">
