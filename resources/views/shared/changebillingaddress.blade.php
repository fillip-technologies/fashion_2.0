<nav id="changebillingaddress"
    class="fixed top-0 right-0 w-full h-screen z-[1200]
           translate-x-full overflow-hidden">

    <div class="relative h-screen w-full">
        <div class="changebillingaddress-backdrop hidden md:block absolute inset-0 bg-black/80
            overflow-hidden overscroll-none"
            onclick="toggleMasterDrawer('changebillingaddress')"></div>

        <div
            class="changebillingaddress-panel absolute top-0 right-0 bg-white h-screen w-full md:w-1/2
            overflow-hidden overscroll-none">
            ...
            md:items-center md:justify-between gap-4 md:gap-0">
              ...
              leading-snug md:leading-normal"
                       ...
                       underline text-black/50"
                            ...
                            <button onclick="toggleMasterDrawer('changebillingaddress')"
                        ...
                        <div class="relative">
                            <div class="text-[0.75rem]" style="font-weight: 400">
                                <div
                                    ...
                                    <div class="col-span-12 space-y-5 relative phone-wrapperchangebilling">
                                        ...
                                        border-b border-border pb-1 cursor-pointer"
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <span id="selectedCodechangebilling"
                                                        class="text-[0.75rem] text-black/60" style="font-weight: 400">
                                                        (+91)
                                                    </span>
                                                </div>

                                                <i id="phoneChevronchangebilling"
                                        ...
                                        <div id="countryDropdownchangebilling"
                                ...
                                bg-background shadow-2xl z-[300] hidden">
                                            ...
                                            <div class="px-6 py-5 space-y-4 text-[0.75rem]" style="font-weight: 400">
                                                ...
                                                <div onclick="selectCountrychangebilling('In', '+91')"
                                                    class="flex justify-between cursor-pointer hover:opacity-70">
                                                    <span>India</span>
                                                    <span>(+91)</span>
                                                </div>

                                                <div onclick="selectCountrychangebilling('It', '+39')"
                                                    class="flex justify-between cursor-pointer hover:opacity-70">
                                                    <span>Italy</span>
                                                    <span>(+39)</span>
                                                </div>

                                                <div onclick="selectCountrychangebilling('Fr', '+33')"
                                                    class="flex justify-between cursor-pointer hover:opacity-70">
                                                    <span>France</span>
                                                    <span>(+33)</span>
                                                </div>

                                                <div onclick="selectCountrychangebilling('Jp', '+81')"
                                                    class="flex justify-between cursor-pointer hover:opacity-70">
                                                    <span>Japan</span>
                                                    <span>(+81)</span>
                                                </div>
                                ...
                                <div
                                    ...
                                    <p>Do you want to use this address also as your shipping address?</p>
                                </div>
...
<style>
    ...
    #changebillingaddress.translate-x-0 {
        pointer-events: auto;
        visibility: visible;
        transition-delay: 0s;
    }

    #changebillingaddress .changebillingaddress-backdrop {
        /* opacity: 0;
        transition: opacity 220ms ease; */
    }

    #changebillingaddress .changebillingaddress-panel {
    ...
    #changebillingaddress.translate-x-0 .changebillingaddress-backdrop {
        /* opacity: 1; */
    }

    #changebillingaddress.translate-x-0 .changebillingaddress-panel {
...
<script>
    function toggleCountryDropdownChangeBilling() {
        const dropdown = document.getElementById("countryDropdownchangebilling");
        const chevron = document.getElementById("phoneChevronchangebilling");

        dropdown.classList.toggle("hidden");
        chevron.classList.toggle("rotate-180");
    }

    function selectCountrychangebilling(code, dial) {
        document.getElementById("selectedCountrychangebilling").textContent = code;
        document.getElementById("selectedCodechangebilling").textContent = `(${dial})`;

        document.getElementById("countryDropdownchangebilling").classList.add("hidden");
        document.getElementById("phoneChevronchangebilling").classList.remove("rotate-180");
    }

    // Optional: click outside to close
    document.addEventListener("click", function(e) {
        const wrapper = document.querySelector(".phone-wrapperchangebilling");
