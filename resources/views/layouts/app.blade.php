            ...
            theme: {
                extend: {
                    ...
                    backgroundImage: {
                        ...
                        'dash-dot-black': 'repeating-linear-gradient(to right, rgba(0,0,0) 0 8px, transparent 8px 12px, rgba(0,0,0) 12px 20px, transparent 20px 24px, rgba(0,0,0) 24px 26px, transparent 20px 30px)',
                        ...
                        'dash-dot-v-black': 'repeating-linear-gradient(to bottom, rgba(0,0,0) 0 8px, transparent 8px 12px, rgba(0,0,0) 12px 20px, transparent 20px 24px, rgba(0,0,0) 24px 26px, transparent 26px 30px)',
